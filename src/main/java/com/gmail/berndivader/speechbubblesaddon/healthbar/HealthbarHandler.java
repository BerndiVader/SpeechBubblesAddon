package com.gmail.berndivader.speechbubblesaddon.healthbar;
...
import com.gmail.berndivader.speechbubblesaddon.SpeechBubblesAddon;
...
implements 
Listener {
	protected static Plugin plugin=SpeechBubblesAddon.getPlugin();
	protected static Logger logger=SpeechBubblesAddon.logger;
	...
	public HealthbarHandler(Plugin plugin) {
		...
		SpeechBubblesAddon.pluginmanager.registerEvents(this, plugin);
	}
